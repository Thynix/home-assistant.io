...
2. Log in with your ecobee credentials. (Make sure your password is at most 16 characters to meet the developer login form's limit and that multifactor authentication is disabled to allow login. You can re-enable MFA after becoming developer.)
